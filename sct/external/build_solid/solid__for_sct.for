      subroutine solid(glad,glod,iyr,imo,idy,tsecv,utv,vtv,wtv)

*** calculate SET at given location for one day with 60 seconds resolution
...
*** Returns:   seconds,  SET_east,  SET_north,  SET_up
      ...
      !*** output variables
      double precision, intent(out) :: tsecv(1441)
      double precision, intent(out) :: utv(1441)
      double precision, intent(out) :: vtv(1441)
      double precision, intent(out) :: wtv(1441)
